...
const descriptionTranslations = {
  bg: {
    ...
    'OSAIK "36 Monkeys"': 'Съвременна театрална трупа, специализираща се в експериментални представления.',
  ...
  mk: {
    ...
    'OSAIK "36 Monkeys"': 'Современа театарска трупа, специјализирана за експериментални претстави.',
  ...
  sr: {
    ...
    'OSAIK "36 Monkeys"': 'Савремена позоришна трупа, специјализована за експерименталне представе.',
