...
const theatreTranslations = {
  en: {
    ...
    165: {
      ...
      history: 'Founded as an independent artistic collective, OSAIK "39 Monkeys" has gained recognition for its avant-garde approach to theatre and commitment to pushing artistic boundaries.'
    },
    166: {
  ...
  bg: {
    ...
    165: {
      ...
      history: 'Основана като независим артистичен колектив, ОСАИК "39 Маймуни" е спечелила признание за своя авангарден подход към театъра и ангажимент към преодоляване на артистичните граници.'
    },
    166: {
  ...
  mk: {
    ...
    165: {
      ...
      history: 'Основана како независен уметнички колектив, ОСАИК "39 Мајмуни" стекна признание за својот авангарден пристап кон театарот и посветеност на поместување на уметничките граници.'
    },
    166: {
  ...
  sr: {
    ...
    165: {
      ...
      history: 'Основана као независни уметнички колектив, ОСАИК "39 Мајмуна" је стекла признање за свој авангардни приступ позоришту и посвећеност померању уметничких граница.'
    },
    166: {
